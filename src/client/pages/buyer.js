...
const Buyer = () => {
    return (
        ...
        <div className="mx-20 my-12">
            ...
            <h2 className="text-3xl font-bold">Are you are a  <a href="/seller" className="text-white hover:text-violet-800">seller </a>or a <span className="text-violet-800 underline">buyer</span>?</h2>
            <div>
